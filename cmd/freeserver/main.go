...
var srvCli = &cobra.Command{
	...
	Long:  `freeserver presents  a nice (not raw hex) interface to the basecoin blockchain structure.`,
}

var serveCmd = &cobra.Command{
	Use:   "serve",
	Short: "Serve the light REST client for tendermint",
	Long:  "Access freecoin via REST",
	RunE:  serve,
}
...
func main() {
	...
	cmd := cli.PrepareMainCmd(srvCli, "FC", os.ExpandEnv("$HOME/.freecli"))
